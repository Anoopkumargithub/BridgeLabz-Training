...
namespace BridgeLabzTraining.csharp_linkedlist.singly_linkedlist
{
    internal class LibraryManagementSystem
    {
        ...
        class Program
        {
            static void Main(string[] args)
            {
                ...
                LibraryItem b1 = new Book(101, "C# in Depth", "Jon Skeet");
                LibraryItem m1 = new Magazine(102, "Tech Monthly", "Editorial Team");
                LibraryItem d1 = new DVD(103, "Inception", "Christopher Nolan");
